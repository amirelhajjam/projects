...
<section id="container" >
        ...
        <fmt:formatDate value="${Contrat.date_fin}" var="dateString" pattern="yyyy-MM-dd" />
        <fmt:formatDate value="${Contrat.date_debut}" var="dateString1" pattern="yyyy-MM-dd" />
       <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		...
          		<br><br><br>
          		${param.msg}
          		    <form:form method="POST"  action="ModifierContrat.html" modelAttribute="Contrat">
                      ...
                      <br><br><br>
                       <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="date_d" type="date" required="true" value="${dateString}"  class="form-control" value="${dateString1}" />
                              </div>
                      </div>
                      <br><br><br>
                       <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="date_f" type="date" required="true" value="${dateString1}" class="form-control"  />
                              </div>
                      </div>
                      <br><br><br>
                       <div class="form-group">
