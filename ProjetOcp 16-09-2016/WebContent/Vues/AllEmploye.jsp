  ...
  <c:import url="Layouts/header.jsp"></c:import>
       ...
       <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		<div class="col-lg-12" ng-controller="empctrl">
          		{{loadData('${employes}')}}
          		<div class="col-lg-4">
          		...
          		<table class="table table-striped table-advance table-hover">
          		   ...
          		   <thead>
                              <tr>
                                  ...
                                  <th><i class="fa fa-bookmark"></i> matricule </th>
                                  <th><i class="glyphicon glyphicon-calendar"></i>grade</th>
                                
                              </tr>
                   </thead>
                   <tbody >
                             
                              <tr ng-repeat="employe in employee | filter : {nom:nom} | filter : {email:email} ">
                                 <td>{{employe.nom}} </td>
                                  <td>{{employe.email}} </td>
